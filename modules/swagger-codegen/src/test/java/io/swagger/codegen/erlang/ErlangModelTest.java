...
public class ErlangModelTest {

    @Test(description = "convert a simple Erlang model")
    public void simpleModelTest() {
        final Model model = new ModelImpl()
                ...
                .required("id")
                .required("name");
        final DefaultCodegen codegen = new ErlangClientCodegen();
    ...
    public void mapPropertyTest() {
        ...
        Assert.assertEquals(property1.datatype, "#{string() => string()}");
    ...
    public void complexMapProperty() {
        ...
        Assert.assertEquals(property1.datatype, "#{string() => children()}");
        Assert.assertEquals(property1.name, "Children");
        Assert.assertEquals(property1.baseType, "map");
        Assert.assertEquals(property1.containerType, "map");
        Assert.assertNull(property1.required);
